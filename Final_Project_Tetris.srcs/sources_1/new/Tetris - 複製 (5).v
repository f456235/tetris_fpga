...
module Tetris(
    ...
    reg [4-1:0]stacking_array[10-1:0][23-1:0];
    output [4-1:0] hold;
    ...
    reg drawing;
    assign fallingblock_out[3:0]=fallingblock;
    ...
    parameter FALLING_TIME=27'd7;
    parameter ACTION_TIME_C1=27'd1;
    parameter ACTION_TIME_D1=27'd2;
    parameter ACTION_TIME_C2=27'd3;
    parameter ACTION_TIME_D2=27'd4;
    parameter ACTION_TIME_C3=27'd5;
    parameter ACTION_TIME_D3=27'd6;
...
//        posymove=posy;
                ...
                case(fallingblock)
                    ...
                    begin
                        case(angle)
                            ...
                            if(posy-1==0)
                                next_ctbr=0;
                            else if(stacking_array[posx][posy-2]==EMPTY)
                                next_ctbr=1;
                            2'd2:
                            if(posy==0)
                                next_ctbr=0;
                            else if(stacking_array[posx-1][posy-1]==EMPTY&&stacking_array[posx][posy-1]==EMPTY&&stacking_array[posx+1][posy-1]==EMPTY&&stacking_array[posx+2][posy-1]==EMPTY)
                                next_ctbr=1;
                            2'd3:
                            if(posy-2==0)
                                next_ctbr=0;
                            else if(stacking_array[posx][posy-3]==EMPTY)
                                next_ctbr=1;
                        endcase
                    end
                    J:
                        ...
                        case(keyboard_state_delay)
                            ...
                            begin
                                case(angle)
                                    ...
                                    if(posx-2==4'd0)
                                        next_calr=0;
                                    else if(stacking_array[posx-3][posy]==EMPTY)
                                        next_calr=1;
                                    2'd1:
                                    if(posx==4'd0)
                                        next_calr=0;
                                    else if(stacking_array[posx-1][posy-1]==EMPTY&&stacking_array[posx-1][posy]==EMPTY&&stacking_array[posx-1][posy+1]==EMPTY&&stacking_array[posx-1][posy+2]==EMPTY)
                                        next_calr=1;
                                    2'd2:
                                    if(posx-1==4'd0)
                                        next_calr=0;
                                    else if(stacking_array[posx-2][posy]==EMPTY)
                                        next_calr=1;
                                    2'd3:
                                    if(posx==4'd0)
                                        next_calr=0;
                            ...
                            begin
                                case(angle)
                                    2'd0:
                                    if(posy+2>5'd22||posy-1<5'd0)
                                        next_calr=0;
                                    else if(stacking_array[posx][posy-1]==EMPTY&&stacking_array[posx][posy+1]==EMPTY&&stacking_array[posx][posy+2]==EMPTY)
                                        next_calr=1;
                                    2'd1:
                                    if(posx-1<4'd0||posx+2>4'd9)
                                        next_calr=0;
                                    else if(stacking_array[posx-1][posy]==EMPTY&&stacking_array[posx+1][posy]==EMPTY&&stacking_array[posx+2][posy]==EMPTY)
                                        next_calr=1;
                                    2'd2:
                                    if(posy+1>5'd22||posy-2<5'd0)
                                        next_calr=0;
                                    else if(stacking_array[posx][posy+1]==EMPTY&&stacking_array[posx][posy-1]==EMPTY&&stacking_array[posx][posy-2]==EMPTY)
                                        next_calr=1;
                                    2'd3:
                                    if(posx-2<4'd0||posx+1>4'd9)
                                        next_calr=0;
                                    else if(stacking_array[posx-2][posy]==EMPTY&&stacking_array[posx-1][posy]==EMPTY&&stacking_array[posx+1][posy]==EMPTY)
                                        next_calr=1;
                                endcase
                            end
                            COUNTERCLOCKWISE:
                    ...
                    begin
                        case(keyboard_state_delay)
                            ...
                            begin
                                ...
                                if(posx-1==4'd0)
                                    next_calr=0;
                                else if(stacking_array[posx-2][posy]==EMPTY&&stacking_array[posx-2][posy+1]==EMPTY)
                                    next_calr=1;
                                2'd1:
                                if(posx==4'd0)
                                    next_calr=0;
                                else if(stacking_array[posx-1][posy+1]==EMPTY&&stacking_array[posx-1][posy]==EMPTY&&stacking_array[posx-1][posy-1]==EMPTY)
                                    next_calr=1;
                                2'd2:
                                if(posx-1==4'd0)
                                    next_calr=0;
                                else if(stacking_array[posx-2][posy]==EMPTY&&stacking_array[posx][posy-1]==EMPTY)
                                    next_calr=1;
                                2'd3:
                                if(posx-1==4'd0)
                                    next_calr=0;
                                else if(stacking_array[posx-2][posy-1]==EMPTY&&stacking_array[posx-1][posy]==EMPTY&&stacking_array[posx-1][posy+1]==EMPTY)
                                    next_calr=1;
                                endcase
                            end
                            MOVE_RIGHT:
                            ...
                            begin
                                case(angle)
                                    ...
                                    if(posy+1>5'd22||posy-2<5'd0)
                                        next_calr=0;
                                    else if(stacking_array[posx+1][posy+1]==EMPTY&&stacking_array[posx][posy+1]==EMPTY&&stacking_array[posx][posy-1]==EMPTY)
                                        next_calr=1;
                                    2'd1:
                                    if(posx-1<4'd0||posx+1>4'd9)
                                        next_calr=0;
                                    else if(stacking_array[posx-1][posy]==EMPTY&&stacking_array[posx+1][posy]==EMPTY&&stacking_array[posx+2][posy]==EMPTY)
                                        next_calr=1;
                                    2'd2:
                    ...
                    begin
                        case(keyboard_state_delay)
                            ...
                            begin
                                if(posx==4'd9)
                                    next_calr=0;
                                else if(stacking_array[posx+1][posy]==EMPTY&&stacking_array[posx+1][posy+1]==EMPTY)
                                    next_calr=1;
                            end
                        endcase
                    end
                    ...
                    begin
                        case(keyboard_state_delay)
                            ...
                            begin
                                if(posx-1==4'd0)
                                    next_calr=0;
                                else if(stacking_array[posx-2][posy]==EMPTY&&stacking_array[posx-1][posy+1]==EMPTY)
                                    next_calr=1;
                            end
                            MOVE_RIGHT:
                            begin
                                if(posx+1==4'd9)
                                    next_calr=0;
                                else if(stacking_array[posx+1][posy]==EMPTY&&stacking_array[posx+2][posy+1]==EMPTY)
                                    next_calr=1;
                            end
                        endcase
                    end
        ...
        case(next_fallingblock)
            ...
            begin
                ...
                2'd1:
                begin
                    stacking_array[next_posx+1][next_posy+1]=EMPTY;
                    stacking_array[next_posx][next_posy+1]=EMPTY;
                    stacking_array[next_posx][next_posy]=EMPTY;
                    stacking_array[next_posx][next_posy-1]=EMPTY;
                end
                2'd2:
                begin
                    stacking_array[next_posx+1][next_posy-1]=EMPTY;
                    stacking_array[next_posx+1][next_posy]=EMPTY;
                    stacking_array[next_posx][next_posy]=EMPTY;
                    stacking_array[next_posx-1][next_posy]=EMPTY;
                end
                2'd3:
